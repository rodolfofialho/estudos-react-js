  ...
  return(
    <div className="app">
      ...
      <div className="area-input">
        <input type="text" placeholder="Peso em (kg) Ex:86" value={peso} onChange={ (e) => setPeso(e.target.value)}/>

        <input type="text" placeholder="ALtura em (cm) Ex:150" value={altura} onChange={ (e) => setAltura(e.target.value)}/>
